...
- **No Jira ticket keys in any description body.** Epic Link, `Relates`, `Blocks`, and Cloners links live in Jira's Links panel; repeating them in the text is redundant and goes stale. Applies to every template in both lanes (TPM rule, 2026-09-04).
